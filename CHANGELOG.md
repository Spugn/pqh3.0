...
- Obfuscated JP database support v4
  - Updated updater script to work with JP `10055900`, this may break again in the future
  - Older versions of the JP database (`10055800` and below) are no longer supported
