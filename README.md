...
In any case, it's been about 5.5 years (`January 10, 2019`) since I started working on the inital version of `priconne-quest-helper` (<https://github.com/Expugn/priconne-quest-helper>). I've learned a lot thanks to this project because it gave me an excuse to dive into looking at various languages and technologies I wouldn't have bothered to look into otherwise. I can't recommend starting a project similar to `priconne-quest-helper` enough to anyone aspiring to learn or become a better programmer because it definitely helped me (although, I can't recommend datamining from a live service game and maintaining a project reading that data...).
